...
export const CreatePoint = () => {
    ...
    useEffect(() => {
        axios.get<Array<IBGEUFRespose>>('https://servicodados.ibge.gov.br/api/v1/localidades/estados')
            .then(response => {
    ...
    useEffect(() => {
        ...
        axios.get<Array<IBGECityResponse>>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`).then(
            response => {
                const citiesResult = response.data.map(city => city.nome)
    ...
    const handleSelectionUf = (event: ChangeEvent<HTMLSelectElement>) => {
